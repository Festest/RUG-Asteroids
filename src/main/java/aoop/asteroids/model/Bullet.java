...
public class Bullet extends GameObject {
	 ...
	 */
	public Bullet(double locationX, double locationY, double velocityX, double velocityY, Spaceship spaceship) {
		this(locationX, locationY, velocityX, velocityY, DEFAULT_BULLET_STEP_LIFETIME, spaceship);
	}
     ...
     */
	private Bullet (double locationX, double locationY, double velocityX, double velocityY, int stepsLeft, Spaceship spaceship) {
	...
	/**
	 * @return the spaceship that originated this bullet
	 */
