...
public class Spaceship extends GameObject {
	...
	/** Username to be displayed above the spaceship. */
	...
	public Spaceship() {
		...
		this.spaceshipColor = Color.BLACK;
		this.reset();
	}
	...
	/**
	 * Set the username of the spaceship
	 ...
	 * @param spaceshipColor the color to be set
	 */
	public void setSpaceshipColor(Color spaceshipColor) {
	...
	/**
	 * Retrieve the username of the ship
	 * @return The username of the ship
	 */
	...
	/**
	 * Retrieve the color of the ship
	 * @return the color of the ship
	 */
	public Color getSpaceshipColor() {
		return this.spaceshipColor;
	}
